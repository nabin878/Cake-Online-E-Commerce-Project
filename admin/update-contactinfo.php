...
$sql="update pusoe_contactusinfo set Address=:address,EmailId=:email,ContactNo=:contactno";
...
<head>
	...
	<title>Pusoe Bakers | Create Brand</title>
	...
	<?php include('includes/leftbar.php');?>
		<div class="content-wrapper">
			<div class="container-fluid">
				...
				<?php $sql = "SELECT * from  pusoe_contactusinfo ";
$query = $dbh -> prepare($sql);
$query->execute();
