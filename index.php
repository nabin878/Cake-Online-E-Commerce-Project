...
<link href="assets2/css/slick.css" rel="stylesheset">
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>Bite into Happiness at Pusoe Bakers.</h1>
            <p>We have more than twenty cake flavours for you to choose. </p>
            <a href="category.php" class="btn">Order Now <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
...
<span class="price">NRP <?php echo htmlentities($row['productPrice']);?> <s>  NRP <?php echo htmlentities($row['productPriceBeforeDiscount']);?></s></span>
...
$tid=1;
$sql = "SELECT pusoe_testimonial.Testimonial,pusoe_users.FullName from pusoe_testimonial join pusoe_users on pusoe_testimonial.UserEmail=pusoe_users.EmailId where pusoe_testimonial.status=:tid";
