...
?>
					...
					<form class="register-form" role="form" method="post" name="register" onSubmit="return validateForm();">
<div class="form-group">
					    <label class="info-title" for="name">Name<span>*</span></label>
					    <input type="text" class="form-control unicase-form-control text-input" value="<?php echo $row['name'];?>" id="name" name="name" required="required" pattern="^[A-Za-z\s]{1,}[\.]{0,1}[A-Za-z\s]{0,}$" title="Please enter a valid name">
					  </div>
...
<div class="form-group">
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" fid="newpass" name="newpass">
					  </div>
					  <div class="form-group">
		...
		<script>
            ...
            var phoneNumber = document.forms["register"]["contactno"].value;

            // Remove any non-numeric characters (e.g., spaces, hyphens, parentheses)
